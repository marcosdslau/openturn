...
function useNavItems(): NavItem[] {
  ...
  return useMemo(() => [
    ...
    },
    {
      icon: <BoxCubeIcon />,
      name: "Equipamentos",
      path: `${base}/equipamentos`,
    },
  ], [base]); // Depend only on base (which depends on code)
}
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (["main", "demo", "support", "others"] as const).forEach((menuType) => {
      const items =
        menuType === "main"
          ? navItems
          : menuType === "demo"
  ...
  const handleSubmenuToggle = (
    index: number,
    menuType: "main" | "demo" | "support" | "others"
  ) => {
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              {renderMenuItems(demoNavItems, "demo")}
            </div>
