...
export function getJobsExchange() {
  return `${p()}_jobs`;
}
export function getJobsRetryExchange() {
  return `${p()}_jobs.retry`;
}
export function getJobsDlxExchange() {
  return `${p()}_jobs.dlx`;
}
export function getJobsDlxQueue() {
  return `${p()}_q.rotina.dlq`;
}
export function getGlobalRetryQueue() {
  return `${p()}_q.rotina.retry`;
}
