...
export class AiController {
    ...
    async getRoutineMessages(
        ...
        const conversa = await this.conversationService.getConversationById(instituicaoCodigo, conversaCodigo);
        return await this.conversationService.getMessages(instituicaoCodigo, conversa.AICCodigo);
    }
    ...
    async getUsage(
        ...
        const userCodigo = (req as any).user?.USRCodigo || 1;
        const used = await this.usageService.getDailyTokensUsed(instituicaoCodigo, userCodigo);
