...
export class RotinaController {
  ...
  async create(
    ...
    const finalInstituicaoCodigo =
      instituicaoCodigo || data.INSInstituicaoCodigo;
    return this.rotinaService.create(
      data,
      finalInstituicaoCodigo,
      usuarioCodigo,
    );
  }
  ...
  async update(
    ...
    const usuarioCodigo = req.user?.userId;
    return this.rotinaService.update(
      id,
      data,
      instituicaoCodigo,
      usuarioCodigo,
