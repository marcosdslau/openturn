...
export class RotinaExecutionController {
    ...
    async bulkAction(
        ...
        const { action } = data;
        if (action === 'delete') {
            assertInstitutionPermission(req.user, instituicaoCodigo, 'execucao', 'delete');
        } else if (action === 'reprocess') {
            assertInstitutionPermission(req.user, instituicaoCodigo, 'execucao', 'reprocess');
        } else if (action === 'cancel') {
            assertInstitutionPermission(req.user, instituicaoCodigo, 'execucao', 'cancel_run');
        }
