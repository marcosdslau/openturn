...
export class MatriculaService {
    ...
    async findAll(instituicaoCodigo: number, query: QueryMatriculaDto): Promise<PaginatedResult<any>> {
    ...
    async findOpcoesFiltro(instituicaoCodigo: number): Promise<{
        ...
        const base: Prisma.MATMatriculaWhereInput = { INSInstituicaoCodigo: instituicaoCodigo };
